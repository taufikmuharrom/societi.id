...
const Footer = () => {
  ...
  return (
    <div className='bg-white dark:bg-gray-900'>
      <footer className="mx-auto lg:max-w-7xl p-4  sm:p-6 ">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <img src={logo} className="w-40" />
          </div>
          <ul className="flex flex-wrap items-center gap-10 mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
            <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {getYear()} <a href="https://societi.id/" className="hover:underline">SocieTI</a>. All Rights Reserved.
          </span>
